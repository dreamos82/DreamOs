...
void cmd_logo(int argc, char ** argv)
{
    ...
    printf("\n");
    printf("\t              The Dream Operating System v%s\n", OS_VERSION);
    printf("\t                     Welcome to DreamOS\n");
    printf("\t      Where dreams don't become Reality and remain dreams. \n");
    printf("\t             R.I.P - Rest in peace with dreamos ^_^        \n");
    printf("\n\n\n\n");
    video_set_color(WHITE);
}
...
{
    int i = 0;
    development_function_t testing[MAX_TEST] = {
