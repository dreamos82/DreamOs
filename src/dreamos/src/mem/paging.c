...
void init_paging()
{
    ...
    set_pagedir_entry(1023,
                      (unsigned int) current_page_dir,
                      PD_PRESENT | SUPERVISOR,
                      0);
...
/**
  ...
  * @return none
  */
void set_pagedir_entry(int pos,
                       unsigned int base,
                       unsigned char opt1,
                       unsigned char opt2)
{
...
/**
  ...
  * @return none
  */
void set_pagedir_entry_ric(int pd_entry,
                           unsigned int base,
                           unsigned char opt1,
                           unsigned char opt2)
{
...
/**
  ...
  * @return none
  */
void set_pagetable_entry(int pos,
                         unsigned int base,
                         unsigned char opt1,
                         unsigned char opt2)
{
...
/**
  ...
  * @return none
  */
void set_pagetable_entry_ric(int pd_entry,
                             int pt_entry,
                             unsigned int base,
                             unsigned char opt1,
                             unsigned char opt2)
{
    ...
    mod_address = (unsigned int *) ((0XFFC00000 | (pd_entry
        << 12)) + (pt_entry * 4));
    *mod_address = (base & 0xFFFFF000) | opt1 | opt2;
    #ifdef DEBUG
